...
if (isset($_POST['getprofile'])) {
  ...
  $result = mysqli_query($connection, "Select * from `staff` where `email` = '$username'");
...
if (isset($_POST['changeprofile'])) {
  ...
  $profileupdate = mysqli_query($connection, "UPDATE `staff` SET `name`='$name', `mobile`='$mobile' WHERE `email` = '$username' ");
...
<head>
  ...
  <title><?= $project ?> : Staff Profile Update</title>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Staff Profile Update</h3>
                </div>
