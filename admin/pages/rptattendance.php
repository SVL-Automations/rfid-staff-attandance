...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT s.name as staffname, a.date, min(a.time) as InTime, max(a.time) as OutTime
                                        FROM attendance as a INNER JOIN staff as s ON a.staffid = s.id
...
<head>
    ...
    <title><?= $project ?> : Staff Attandance</title>
            ...
            <div class="container">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Staff Attandance</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title"> Staff Attandance</h3>                                    
                                </div>
                    ...
                    success: function(response) {
                        ...
                        $.each(returnedData['list'], function(key, value) {
                            ...
                            var html = '<tr class="odd gradeX">' +
                                ...
                                '<td class="text-center">' + value.InTime + '</td>' +
                                '<td class="text-center">' + value.OutTime  + '</td>' +                                
                                '</tr>';
